...
if not BOT_TOKEN:
    ...
    def send_welcome(message):
        # পরিবর্তন: reply_to এর পরিবর্তে send_message ব্যবহার করা হয়েছে
        bot.send_message(message.chat.id, "হ্যালো! আমি একটি বট। আমাকে কিছু প্রশ্ন করতে পারেন অথবা যেকোনো মেসেজ পাঠাতে পারেন।")
    ...
    def echo_all(message):
        # পরিবর্তন: reply_to এর পরিবর্তে send_message ব্যবহার করা হয়েছে
        bot.send_message(message.chat.id, "আপনার প্রশ্নটি বুঝতে পারিনি। আমি আপনার বার্তাটির প্রতিধ্বনি করছি: " + message.text)

    # বটকে ক্রমাগত চালানোর জন্য
    print("বট সফলভাবে চালু হচ্ছে এবং মেসেজের জন্য অপেক্ষা করছে...")
    bot.infinity_polling(skip_pending=True) # skip_pending=True যোগ করা হয়েছে
